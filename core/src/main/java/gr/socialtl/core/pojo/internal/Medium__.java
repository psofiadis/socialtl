...
public class Medium__ {
     ...
     * @param idStr
     */
    public Medium__(BigInteger id, String idStr, List<Integer> indices, String mediaUrl, String mediaUrlHttps, String url, String displayUrl, String expandedUrl, String type, Sizes_ sizes) {
        this.id = id;
        this.idStr = idStr;
